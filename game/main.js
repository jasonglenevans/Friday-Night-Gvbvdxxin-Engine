...
async function deathSystem() {
	...
	diedScreen = new Sprite(0,0,await renderer.createImage(loadUrl("./assets/images/deadscreen.png","imgage/png")),600,400);
	...
	while (gameScreenStillShowing && (MissedNotes < 26)) {
		await tickAsync();
	}
